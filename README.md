...
```
wget -N --no-check-certificate -q -O install.sh "https://raw.githubusercontent.com/squarecome/V2Ray_ws-tls_bash_onekey/master/v2ray_ws_tls_install.sh" && chmod +x install.sh && bash install.sh
```
